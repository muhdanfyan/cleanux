...
# muhdanfyan/Cleanux release. Usage: post-reactions.sh V<version>
...
RELEASE_ID=$(gh api "repos/muhdanfyan/Cleanux/releases/tags/$TAG" --jq '.id')
...
for r in +1 laugh hooray heart rocket eyes; do
    gh api "repos/muhdanfyan/Cleanux/releases/$RELEASE_ID/reactions" \
